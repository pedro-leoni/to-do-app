import { Box, Button, FormControl, FormLabel, Input, Radio, RadioGroup, Select, Stack, Textarea } from '@chakra-ui/react';
...
const  NewPage = ():JSX.Element => {
    ...
    return (
        <Box maxW='sm' borderWidth='1px' borderRadius='lg' padding={3}>
            <form onSubmit={handleSubmit}>
                ...
                <FormControl isRequired>
                    ...
                    <Select placeholder='Priority level from 1 to 3' name='priority' onChange={handleChange}>
                ...
                <FormControl isRequired>
                    ...
                    <RadioGroup  name='state' onChange={handleRadioChange}>
                        <Stack direction='row'>
